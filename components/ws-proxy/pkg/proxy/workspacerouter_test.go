...
func TestWorkspaceRouter(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			URL:  "http://regional-amaranth-smelt-9ba20cc1.ws.gitpod.dev/",
			Headers: map[string]string{
				forwardedHostnameHeader: "regional-amaranth-smelt-9ba20cc1.ws.gitpod.dev",
			},
		...
		},
		{
			...
			URL:  "http://1234-regional-amaranth-smelt-9ba20cc1.ws.gitpod.dev/",
			Headers: map[string]string{
				forwardedHostnameHeader: "1234-regional-amaranth-smelt-9ba20cc1.ws.gitpod.dev",
			},
			Router:       HostBasedRouter(forwardedHostnameHeader, wsHostSuffix),
			WSHostSuffix: wsHostSuffix,
			Expected: Expectation{
		...
		},
		{
			...
			URL:  "http://localhost/regional-amaranth-smelt-9ba20cc1",
			Router: func(r *mux.Router, wsInfoProvider WorkspaceInfoProvider) (theiaRouter *mux.Router, portRouter *mux.Router, blobserveRouter *mux.Router) {
		...
		},
		{
			...
			URL:  "http://localhost/regional-amaranth-smelt-9ba20cc1/services",
			Router: func(r *mux.Router, wsInfoProvider WorkspaceInfoProvider) (theiaRouter *mux.Router, portRouter *mux.Router, blobserveRouter *mux.Router) {
				return pathBasedTheiaRouter(r, wsInfoProvider, ""), nil, nil
			},
			Infos: []WorkspaceInfo{
		...
		},
		{
			...
			URL:  "http://localhost/workspace/regional-amaranth-smelt-9ba20cc1/services",
			Router: func(r *mux.Router, wsInfoProvider WorkspaceInfoProvider) (theiaRouter *mux.Router, portRouter *mux.Router, blobserveRouter *mux.Router) {
		...
		},
		{
			...
			URL:  "http://8080-regional-amaranth-smelt-9ba20cc1.ws.gitpod.dev/",
			Headers: map[string]string{
				forwardedHostnameHeader: "8080-regional-amaranth-smelt-9ba20cc1.ws.gitpod.dev",
			},
			Router: PathAndHostRouter("/workspace/", forwardedHostnameHeader, wsHostSuffix),
			Infos: []WorkspaceInfo{
				{
...
func TestMatchWorkspaceHostHeader(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			HostHeader: "regional-amaranth-smelt-9ba20cc1" + wsHostSuffix,
			Expected: matchResult{
				MatchesWorkspace: true,
				WorkspaceVars: map[string]string{
					foreignOriginPrefix:   "",
					workspaceIDIdentifier: "regional-amaranth-smelt-9ba20cc1",
				},
			},
		},
		{
			Name:       "webview workspace match",
			HostHeader: "webview-regional-amaranth-smelt-9ba20cc1" + wsHostSuffix,
			Expected: matchResult{
				MatchesWorkspace: true,
				WorkspaceVars: map[string]string{
		...
		},
		{
			...
			HostHeader: "browser-regional-amaranth-smelt-9ba20cc1" + wsHostSuffix,
			Expected: matchResult{
				MatchesWorkspace: true,
				WorkspaceVars: map[string]string{
		...
		{
			Name:       "port match",
			HostHeader: "8080-regional-amaranth-smelt-9ba20cc1" + wsHostSuffix,
			Expected: matchResult{
				MatchesPort: true,
				PortVars: map[string]string{
					foreignOriginPrefix:     "",
		...
		},
		{
			...
			HostHeader: "webview-8080-regional-amaranth-smelt-9ba20cc1" + wsHostSuffix,
			Expected: matchResult{
				MatchesPort: true,
				PortVars: map[string]string{
					foreignOriginPrefix:     "webview-",
		...
		},
		{
			...
			HostHeader: "browser-8080-regional-amaranth-smelt-9ba20cc1" + wsHostSuffix,
			Expected: matchResult{
				MatchesPort: true,
				PortVars: map[string]string{
					foreignOriginPrefix:     "browser-",
