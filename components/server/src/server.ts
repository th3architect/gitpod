...
import { DeletedEntryGC } from '@gitpod/gitpod-db/lib/typeorm/deleted-entry-gc';
...
export class Server<C extends GitpodClient, S extends GitpodServer> {
    ...
    @inject(BlobsController) protected readonly blobsController: BlobsController;
    ...
    protected async registerRoutes(app: express.Application) {
        ...
        app.use('/blob-service', this.blobsController.apiRouter);
